...
export default function Home() {
  const features = [
    { title: "Lightning Fast", description: "Optimized for speed and performance.", iconName: "Zap" as const },
    {
      title: "Secure by Design",
      description: "Built with security best practices to protect against attacks.",
      iconName: "Shield" as const,
    },
    { title: "User-Centric", description: "Focused on creating the best user experience.", iconName: "Users" as const },
  ]
